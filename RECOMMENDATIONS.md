...
- `src/app/pages/comandas/nova-comanda/nova-comanda.component.ts`
...
**Arquivos afetados:**
- `src/app/pages/comandas/comandas-list/comandas-list.component.ts`
...
export class ComandasListComponent implements OnInit, OnDestroy {
...
export class ComandasListComponent {
...
**Exemplo:** `comandas-list.component.ts` - Lógica de cálculo de totais, formatação de dados.
...
### 12.2 `comandas-list.component.ts`
